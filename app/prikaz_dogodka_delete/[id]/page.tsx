            ...
            >
              <div className="w-full h-40 mb-3">
                <img
                  src={
                    dogodek.slika
                      ? `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/dogodki/${dogodek.slika}`
                      : "/placeholder.png"
                  }
                  alt={dogodek.naslov}
              ...
              <div className="flex gap-2 mt-4">
                <button
                  onClick={() =>
                    router.push(`/urejanje_dogodka/${dogodek.id}`)
                  }
                ...
                <button
                  onClick={() =>
                    router.push(`/brisanje_dogodka/${dogodek.id}`)
                  }
